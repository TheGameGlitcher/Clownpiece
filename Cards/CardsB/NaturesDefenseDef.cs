...
{
    public sealed class NaturesDefenseDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(NaturesDefense);
        }
    ...
    [EntityLogic(typeof(NaturesDefenseDef))]
    public sealed class NaturesDefense : ClownCard
    {
        ...
        {
            List<SunflowerFairy> cards = Library.CreateCards<SunflowerFairy>(Value1, false).ToList<SunflowerFairy>();
            foreach (SunflowerFairy card in cards)
            {
