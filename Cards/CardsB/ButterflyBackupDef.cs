...
{
    public sealed class ButterflyBackupDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(ButterflyBackup);
        }
    ...
    [EntityLogic(typeof(ButterflyBackupDef))]
    public sealed class ButterflyBackup : ClownCard
    {
        ...
        {
            List<BlackButterfly> cards = Library.CreateCards<BlackButterfly>(Value1, false).ToList<BlackButterfly>();
            foreach (BlackButterfly card in cards)
            {
