...
{
    public sealed class TemplateFriendDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(TemplateFriend);
        }
    ...
    [EntityLogic(typeof(TemplateFriendDef))]
    public sealed class TemplateFriend : ClownCard
    {
        ...
        public override IEnumerable<BattleAction> GetPassiveActions()
        {
            ...
            for (int i = 0; i < this.Battle.FriendPassiveTimes && !this.Battle.BattleShouldEnd; ++i)
            {
                ...
                yield return PerformAction.Effect(base.Battle.Player, "TemplateFriend", 0f, null, 0f, PerformAction.EffectBehavior.PlayOneShot, 0f);
