...
namespace Clownpiece.Cards.CardsR
{
    ...
    public sealed class HellsNatureDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(HellsNature);
        }
    ...
    [EntityLogic(typeof(HellsNatureDef))]
    public sealed class HellsNature : ClownCard
    {
        ...
        {
            List<HellFairy> cards = Library.CreateCards<HellFairy>(Value1, false).ToList<HellFairy>();
            foreach (HellFairy card in cards)
            {
