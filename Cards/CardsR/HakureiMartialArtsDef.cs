...
{
    public sealed class HakureiMartialArtsDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(HakureiMartialArts);
        }
        ...
        public override CardConfig MakeConfig()
        {
            ...
            IsXCost: false,
            Cost: new ManaGroup() { Red = 1, Any = 3 },
            UpgradedCost: null,
            Kicker: null,
            UpgradedKicker: null,
            MoneyCost: null,
    ...
    [EntityLogic(typeof(HakureiMartialArtsDef))]
    public sealed class HakureiMartialArts : ClownCard
    {
