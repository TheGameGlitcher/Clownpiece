...
{
    public sealed class HellsInfernoDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(HellsInferno);
        }
    ...
    [EntityLogic(typeof(HellsInfernoDef))]
    public sealed class HellsInferno : ClownCard
    {
        protected override IEnumerable<BattleAction> Actions(UnitSelector selector, ManaGroup consumingMana, Interaction precondition)
        {
            yield return new AddCardsToHandAction(Library.CreateCards<RManaCard>(Value1, false), AddCardsType.Normal);
            if (this.IsUpgraded)
            {
