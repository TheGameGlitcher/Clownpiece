...
{
    public sealed class PureTorchBossSeDef : StatusEffectTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(PureTorchBossSe);
        }
        ...
        {
            return ResourceLoader.LoadSprite("PureTorchBossSe.png", BepinexPlugin.embeddedSource);
        }
    ...
    [EntityLogic(typeof(PureTorchBossSeDef))]
    public sealed class PureTorchBossSe : ClownStatus
    {
